    ...
    # --- Pages: public HTML hosting ---
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "permissions unless access_mode is explicitly supplied. Authorized pages render the stored HTML "
                "directly without platform-added execution restrictions. Automatic SSO is opt-in only: append "
                "auto_login=1 to the Page URL only "
