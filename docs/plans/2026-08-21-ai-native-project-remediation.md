...
- [x] Use Monaco for Markdown source editing and a maintained CommonMark/GFM renderer for the rendered preview; persist preview/source mode in the URL and verify both modes on port 3011.
...
- Software-development acceptance: `PulseOps` project `04387e1c-a2d2-4523-9480-4001b6afc54b` completed with 5/5 work items, 12/12 successful Runs, 147 events, 3 milestones, and Git HEAD `54730054fa1cf684bf9c39989ac0a5cc301e6ecb`. No retry is required. Its historical null Run/work-item and incomplete milestone-link fields remain an explicit remediation item; the A2A creation path now persists parent Run and work-item lineage, and historical data must be reconciled before final sign-off.
...
`?tab=work&workView=list` after reload with the list view still selected.
