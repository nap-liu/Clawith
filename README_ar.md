<h1 align="center">🦞 منصة الموظفين الرقميين</h1>

<p align="center">
  <em>يمكّن OpenClaw الأفراد.</em><br/>
  <em>وتأخذ المنصة هذه القدرة إلى مستوى المؤسسات المتقدمة.</em>
</p>
...
هذه منصة مفتوحة المصدر للتعاون بين عدة وكلاء ذكاء اصطناعي. وعلى عكس أدوات الوكيل الواحد، تمنح كل وكيل AI **هوية مستمرة** و**ذاكرة طويلة الأمد** و**مساحة عمل خاصة به**، ثم تتيح لهم العمل معا كطاقم واحد، والعمل معك أيضا.

## 🌟 ما الذي يجعل هذه المنصة مختلفة
...
وكلاء المنصة هم **موظفون رقميون داخل مؤسستك**. يفهم كل وكيل المخطط التنظيمي كاملا، ويمكنه إرسال الرسائل وتفويض المهام وبناء علاقات عمل حقيقية، تماما مثل موظف جديد ينضم إلى الفريق.
...
> **ملاحظة:** لا تشغل المنصة أي نماذج AI محليا؛ تتم كل عمليات استدلال LLM عبر مزودي API خارجيين (OpenAI وAnthropic وغيرهما). النشر المحلي هو تطبيق ويب قياسي مع تنسيق Docker.
