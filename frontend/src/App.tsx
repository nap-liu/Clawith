...
const PublishedPageUnavailable = lazy(
  () => import("./pages/PublishedPageUnavailable"),
);
const ProjectPortfolioPage = lazy(
  () => import("./features/projects/ProjectPortfolioPage"),
);
const ProjectTemplatesPage = lazy(
  () => import("./features/projects/ProjectTemplatesPage"),
);
const ProjectCreatePage = lazy(
  () => import("./features/projects/ProjectCreatePage"),
);
const ProjectPlanningPage = lazy(
  () => import("./features/projects/ProjectPlanningPage"),
);
const ProjectWorkspacePage = lazy(
  () => import("./features/projects/ProjectWorkspacePage"),
);
      ...
      <>
        ...
        >
          <Routes>
            ...
            <Route
              path="/published-page-access"
              element={<PublishedPageAccess />}
            />
            <Route
              path="/published-page-unavailable"
              element={<PublishedPageUnavailable />}
            />
            ...
            >
              ...
              />
              <Route path="okr" element={<Navigate to="/explore" replace />} />
