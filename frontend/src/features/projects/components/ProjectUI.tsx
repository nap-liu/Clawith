...
import { Modal } from "../../../components/Dialog/DialogProvider";
...
export function ProjectField({
  ...
  return (
    ...
    >
      ...
      {children}
      {error ? (
        <small className="project-field__error" role="alert">
          {error}
        </small>
      ) : hint ? (
        <small>{hint}</small>
...
export function ProjectSelect<T extends string>(props: ProjectSelectProps<T>) {
  return (
    <SelectDropdown
      {...props}
      className={["project-select", props.className].filter(Boolean).join(" ")}
    />
  );
}

export const ProjectTextarea = forwardRef<
  HTMLTextAreaElement,
...
>(function ProjectTextarea({ className = "", ...props }, ref) {
  return (
    <textarea
      ref={ref}
      className={["project-textarea", "form-input", className]
        .filter(Boolean)
        .join(" ")}
      {...props}
    />
...
export function ProjectEmptyState({
  ...
  return (
    ...
    >
      {icon && (
        <span className="project-empty-state__icon pm-empty-symbol">
          {icon}
        </span>
      )}
      <strong>{title}</strong>
...
export function ProjectRadioGroup<T extends string>({
  value,
  options,
  onChange,
  ariaLabel,
  className = "",
}: ProjectRadioGroupProps<T>) {
  const radioName = useId();
  return (
    <div
      className={["project-radio-group", className].filter(Boolean).join(" ")}
      role="radiogroup"
...
export function ProjectSegmentedControl<T extends string>({
  ...
  return (
    <div
      className={["project-segmented-control", className]
        .filter(Boolean)
        .join(" ")}
      role="group"
      aria-label={ariaLabel}
      ...
      {options.map((option) => (
        ...
        >
          ...
          {option.count !== undefined && (
            <ProjectCountBadge>{option.count}</ProjectCountBadge>
          )}
        </Button>
      ))}
    </div>
...
export const ProjectIconButton = forwardRef<
  HTMLButtonElement,
...
>(function ProjectIconButton(
  ...
  return (
    <Button
      ...
      type={type}
      variant="ghost"
      className={["project-icon-button", "pm-icon-button", className]
        .filter(Boolean)
        .join(" ")}
      {...props}
    />
...
export function ProjectStatusBadge({
  ...
  return (
    <span
      className={["project-status-badge", `is-${tone}`, className]
        .filter(Boolean)
        .join(" ")}
    >
      <i aria-hidden="true" />
...
export function ProjectCountBadge({
  ...
  return (
    <span
      className={["project-count-badge", className].filter(Boolean).join(" ")}
    >
      {children}
    </span>
  );
...
export function ProjectPanel({
  ...
  return (
    <section
      className={["project-panel", className].filter(Boolean).join(" ")}
      {...props}
    />
  );
}
...
export function ProjectDataTable({
  ...
  return (
    <div className="project-data-table-scroll">
      <table
        className={["project-data-table", className].filter(Boolean).join(" ")}
        {...props}
      />
    </div>
  );
...
export function ProjectDataTableHead(
  props: HTMLAttributes<HTMLTableSectionElement>,
) {
  return <thead {...props} />;
}

export function ProjectDataTableBody(
  props: HTMLAttributes<HTMLTableSectionElement>,
) {
  return <tbody {...props} />;
}

export function ProjectDataTableRow(
  props: HTMLAttributes<HTMLTableRowElement>,
) {
  return <tr {...props} />;
}

export function ProjectDataTableHeader(
  props: ThHTMLAttributes<HTMLTableCellElement>,
) {
  return <th scope="col" {...props} />;
}

export function ProjectDataTableCell(
