...
function entryMessageId(
  entry: ReturnType<typeof buildConversationEntries>[number],
  focusMessageId?: string,
): string | undefined {
...
function describeAnalysis(
  ...
  return (
    parts.join(", ") || t("agent.chat.ranCommands", { count: tools.length })
  );
}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span className="conversation-tool-chip">
                        {meta.label}
                      </span>
                      {meta.target && (
