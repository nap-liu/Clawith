                    ...
                    <div style={{
                        ...
                        <input
                            ...
                            placeholder={t(
                                ...
                                isChinese ? '搜索数字员工名称或能力…' : 'Search agents by name or skill…',
                            )}
                            style={{
                                flex: 1, minWidth: 0,
                            ...
                            aria-label={t('talentMarket.searchLabel', isChinese ? '搜索数字员工' : 'Search agents')}
                        />
                        {searchQuery && (
                            <button
                ...
                <div style={{
                    ...
                    {!isLoading && visibleTemplates.length === 0 && (
                        <div style={{ gridColumn: '1 / -1', padding: '40px', textAlign: 'center', color: 'var(--text-tertiary)', fontSize: '13px' }}>
                            {isSearching
                                ? t('talentMarket.emptySearch', isChinese ? `没有匹配「${trimmedQuery}」的数字员工` : `No agents match "${trimmedQuery}"`)
    ...
    return (
        ...
        >
            ...
            <div style={{ fontSize: '15px', fontWeight: 600, marginBottom: '2px', position: 'relative', zIndex: 1 }}>
                {t('talentMarket.customTitle', isChinese ? '自建数字员工' : 'Build custom')}
            </div>
            <div style={{
                fontSize: '10px', fontWeight: 500, letterSpacing: '0.06em',
                color: 'var(--text-tertiary)', textTransform: 'uppercase',
            ...
            <p style={{
                ...
                {t('talentMarket.customDescription', isChinese
                    ? '创建本地 Native 数字员工，按你的需求定义身份、权限和工具。'
