...
Date-stamped production release notes, one-off data corrections, current fleet inventories, usage-report outputs, current image tags, personal backup locations, host access instructions, and credentials remain operational history rather than repository architecture. Examples include `*_prod_*.md`, `prod_usage_report_method.md`, `prod_server_mem_specs.md`, `backup_location.md`, `prod_access_via_clawith_ssh.md`, and `utm_x86_vm_local_validation_env.md`.
